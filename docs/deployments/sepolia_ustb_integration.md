...
**Network:** Sepolia Testnet (Chain ID: 11155111) **Deployer:** `0x9118964074e2AA11393ce0797264759dB2F2ef69` **Block:**
10288601 **Total Gas:** 11,558,950 (~0.000878 ETH) **Script:** `script/sepolia/DeploySepoliaUstb.s.sol`
...
| -------------------------------- | -------------------------------------------- | --------------------------------------------------------------------------------------- |
| LlamaGuardOracle (USTB)          | `0x08bFEb45bA1437708bB6FBDBa94E04Df0a9F8045` | [View](https://sepolia.etherscan.io/address/0x08bFEb45bA1437708bB6FBDBa94E04Df0a9F8045) |
...
| RawNAVOracle                     | `0xdCb47643002c3259912e1bA65b53b92F81e93703` | [View](https://sepolia.etherscan.io/address/0xdCb47643002c3259912e1bA65b53b92F81e93703) |
...
- Oracle seeded with price `10990051` (10.990051 USD, 8 decimals) from source oracle
  `0x732d3C7515356eAB22E3F3DcA183c5c65102d518`
- `RawNAVOracle` initialized with same seed price
...
```
Cron Job ──writes──► RawNAVOracle (0xdCb4) ──event──► CRE Workflow
                                                        │
Deployer ──bad write─► RawNAVOracle (0xdCb4) ──event──► │
                                                        ▼
                                              LlamaGuardOracleProxy (0x2B07)
                                                        │
                                                        ▼
                                              LlamaGuardOracle (0x08bF)
                                                  │           │
                                                  ▼           ▼
...
cast call 0x08bFEb45bA1437708bB6FBDBa94E04Df0a9F8045 "latestAnswer()(int256)" --rpc-url sepolia

# Deployer has write access
cast call 0x08bFEb45bA1437708bB6FBDBa94E04Df0a9F8045 "hasWriteAccess(address)(bool)" 0x9118964074e2AA11393ce0797264759dB2F2ef69 --rpc-url sepolia

# Proxy has write access
cast call 0x08bFEb45bA1437708bB6FBDBa94E04Df0a9F8045 "hasWriteAccess(address)(bool)" 0x2B079561590C6ACfb6af3C4aF5Bc3927acc98bD2 --rpc-url sepolia

# USTB market authorized
cast call 0x08bFEb45bA1437708bB6FBDBa94E04Df0a9F8045 "isAuthorizedMarket(address)(bool)" 0x39727692cF58137Bd8c401eFE87Cc8A190D62ead --rpc-url sepolia

# EAC returns seeded price
...
cast call 0xdCb47643002c3259912e1bA65b53b92F81e93703 "latestRoundData()(uint80,int256,uint256,uint256,uint80)" --rpc-url sepolia

# RawNAVOracle owned by deployer
cast call 0xdCb47643002c3259912e1bA65b53b92F81e93703 "owner()(address)" --rpc-url sepolia
...
2. **Share with Chainlink** — Give `RawNAVOracle` (`0xdCb47643002c3259912e1bA65b53b92F81e93703`) to Chainlink so they
...
5. **Start cron job** — Begin writing USTB prices to RawNAVOracle:
   ```bash
   cast send 0xdCb47643002c3259912e1bA65b53b92F81e93703 "updateLatestRoundData(int256)" $PRICE --rpc-url sepolia --private-key $PRIVATE_KEY
   ```
...
```bash
cast send 0xdCb47643002c3259912e1bA65b53b92F81e93703 "updateLatestRoundData(int256)" 5000000000 --rpc-url sepolia --private-key $PRIVATE_KEY
```
...
| Transaction                    | Hash                                                                 |
| ------------------------------ | -------------------------------------------------------------------- |
| Deploy LlamaGuardOracle        | `0xc74882935c000b94d75d043899f84d01efcc95fa179c939469900fcdba01e668` |
...
| Deploy RawNAVOracle            | `0x601110679c2754fb932c2f5109a0c55819e5cf5b888f9cde7468a842c740e75f` |
